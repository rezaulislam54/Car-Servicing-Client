  ...
  const data = [
    {
      ...
      description:
        "Embark on a mesmerizing journey through space and time, as John Doe, a passionate astrophysicist, unveils the wonders of our universe. From the majestic galaxies to the mysterious black holes, dive deep into the realms of cosmic beauty and scientific discovery.",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description:
        "Transform your body, mind, and spirit with Michael Johnson, a seasoned fitness coach, as he guides you on a journey toward optimal health and well-being. Discover the power of exercise, nutrition, and mindfulness practices to sculpt your physique, boost your energy levels, and unleash your full potential.",
    },
    {
      id: 4,
    ...
    },
    {
      ...
      description:
        "Nurture your body, mind, and soul with Sarah Johnson, a holistic wellness coach, as she shares her wisdom and practical tips for embracing a balanced and fulfilling lifestyle. From nutritious recipes to invigorating workouts and mindfulness practices, embark on a journey toward optimal health, vitality, and happiness with Sarah as your guide.",
    },
    {
      id: 7,
  ...
  return (
    <div className="my-24">
      <div className="text-center space-y-4">
        ...
        <p className="lg:w-[700px] mx-auto opacity-80 font-medium">
        ...
        <div className="carousel w-full">
          <div id="slide5" className="carousel-item relative w-full">
            <div className="flex gap-5 p-16 flex-col lg:flex-row">
              ...
              {/* 2nd div */}
              <div className="border rounded-xl px-10 py-5  hidden md:block">
                <div className="flex items-center gap-5">
                  <img
                    className="rounded-full h-[60px] w-[60px]"
                    src={data[1].author_img}
                    alt=""
                  />
                  <div>

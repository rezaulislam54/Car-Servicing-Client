      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mt-10">
        <div className="border rounded-lg p-6 text-center">
          ...
          <div className="flex gap-2 justify-center mt-3">
            ...
            <h1 className="text-white bg-[#55ACEE] h-8 w-8 rounded-full flex items-center justify-center">
              <FaTwitter className="text-xl" />
            </h1>
            <h1 className="text-white bg-[#BD4697] h-8 w-8 rounded-full flex items-center justify-center">
              <FaInstagram className="text-xl" />
            </h1>
            <h1 className="text-white bg-[#0A66C2] h-8 w-8 rounded-full flex items-center justify-center">
